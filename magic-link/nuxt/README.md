...
This is a Nuxt/Supabase project showing how to do magic link and otp login.
...
```bash
npx degit supabase-community/supabase-by-example/magic-link/nuxt project-name
cd project-name
