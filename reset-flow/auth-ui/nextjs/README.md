...
- [Supabase Auth UI React](https://supabase.com/docs/guides/auth/auth-ui)
...
```bash
npx degit supabase-community/supabase-by-example/reset-flow/auth-ui/nextjs project-name
cd project-name
